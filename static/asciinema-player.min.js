var AsciinemaPlayer = (function (A) {
  ...
  function D(A, g) {
    ...
    return [
      u.bind(I),
      (A) => ('function' == typeof A && (A = A(I.value)), F(I, A)),
    ];
  }
  function w(A, g, I) {
    d(f(A, g, !1, E));
  ...
  function M(A) {
    return (
      null === t ||
        (null === t.cleanups ? (t.cleanups = [A]) : t.cleanups.push(A)),
      A
    );
  }
  function k() {
    ...
    ((s = t = A),
      (function (A, g, I) {
        ...
        try {
          ...
          (A.pure &&
            ((A.state = E), A.owned && A.owned.forEach(U), (A.owned = null)),
            H(g));
        }
        (!A.updatedAt || A.updatedAt <= I) &&
          (null != A.updatedAt && 'observers' in A ? F(A, B) : (A.value = B),
          (A.updatedAt = I));
      })(A, A.value, B),
      (s = I),
      (t = g));
  ...
  function f(A, g, I, B = E, Q) {
    ...
    return (
      null === t || (t !== i && (t.owned ? t.owned.push(C) : (t.owned = [C]))),
      C
    );
  }
  function Y(A) {
    ...
    if (A.suspense && y(A.suspense.inFallback))
      return A.suspense.effects.push(A);
    const I = [A];
    for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < a); )
      (A.state || g) && I.push(A);
  ...
  function L(A) {
    ...
    for (let I = 0; I < A.observers.length; I += 1) {
      ...
      (B.state && !g) ||
        ((B.state = e), B.pure ? n.push(B) : r.push(B), B.observers && L(B));
    }
  }
  function U(A) {
    let g;
              ...
              y(() => {
                ...
                if (0 === y)
                  (0 !== e &&
                    ...
                    I.fallback &&
                      ((Q = [m]),
                      (C[0] = c((A) => ((E[0] = A), I.fallback()))),
                      (e = 1)));
                else if (0 === e) {
                  for (C = new Array(y), o = 0; o < y; o++)
                    ((Q[o] = s[o]), (C[o] = c(n)));
                  e = y;
                } else {
                  for (
  ...
  function O(A, g, I, B = {}) {
    ...
    return (
      c((B) => {
        ((Q = B),
          g === document ? A() : AA(g, A(), g.firstChild ? null : void 0, I));
      }, B.owner),
      () => {
        (Q(), (g.textContent = ''));
      }
  ...
  function gA(A) {
    ...
    for (
      ...
      if (g && !B.disabled) {
        const Q = B[`${I}Data`];
        if ((void 0 !== Q ? g.call(B, Q, A) : g.call(B, A), A.cancelBubble))
          return;
      }
  ...
  function IA(A, I, B, Q, C) {
    for (g.context && !B && (B = [...A.childNodes]); 'function' == typeof B; )
      B = B();
    if (I === B) return B;
    const E = typeof I,
      e = void 0 !== Q;
    if (
      ((A = (e && B[0] && B[0].parentNode) || A),
      'string' === E || 'number' === E)
    ) {
              ...
              : (function (A, g, I) {
                  ...
                  for (; E < Q || e < C; )
                    if (g[E] !== I[e]) {
                      ...
                      if (Q === E) {
                        const g =
                          C < B ? (e ? I[e - 1].nextSibling : I[C - e]) : i;
    ...
    for (let C = 0, E = g.length; C < E; C++) {
      ...
      if (E instanceof Node) A.push(E);
        ...
        if (B) {
          ...
          Q =
            BA(A, Array.isArray(E) ? E : [E], Array.isArray(e) ? e : [e]) || Q;
        } else (A.push(E), (Q = !0));
      else {
        const g = String(E);
        e && 3 === e.nodeType && e.data === g
          ? A.push(e)
  ...
  function rA() {
    return (
      (null !== nA && 0 !== nA.byteLength) ||
        (nA = new Uint8Array(EA.memory.buffer)),
      nA
    );
  }
  function aA(A, g) {
  ...
  function MA() {
    return (
      (null !== GA && 0 !== GA.byteLength) ||
        (GA = new Int32Array(EA.memory.buffer)),
      GA
    );
  }
  let kA = null;
  function NA(A, g) {
    return ((null !== kA && 0 !== kA.byteLength) ||
      (kA = new Uint32Array(EA.memory.buffer)),
  ...
  class qA extends KA {
    ...
    async doPlay() {
      ...
      !0 === A
        ...
        : 'function' == typeof A &&
          (this.core.setState('playing'), (this.driver.stop = A));
    }
    togglePlay() {
      return this.play();
    }
  ...
  class TA {
    ...
    getCursor() {
      return (
        void 0 === this.cursor &&
          this.vt &&
          (this.cursor = this.vt.get_cursor() ?? !1),
        this.cursor
      );
    }
    getCurrentTime() {
    ...
    doFeed(A) {
      ...
      if (
        (g.forEach((A) => this.changedLines.add(A)), (this.cursor = void 0), I)
      ) {
  ...
  function XA(A, g) {
    ...
    if (
      !B &&
      (Object.defineProperty(A, I, { value: (B = new Proxy(A, gg)) }),
      !Array.isArray(A))
    ) {
  ...
  function VA(A, g = new Set()) {
    ...
    if (Array.isArray(A)) {
      ...
      for (let e = 0, i = I.length; e < i; e++)
        ((C = I[e]),
          E[C].get || ((Q = A[C]), (B = VA(Q, g)) !== Q && (A[C] = B)));
    }
    return A;
  }
  function PA(A) {
  ...
  var Ng = (A) => {
    const g = (A) => (g) => {
      ...
      I = () =>
        'number' == typeof A.currentTime ? Mg(A.currentTime) : '--:--',
      B = () =>
        'number' == typeof A.remainingTime ? '-' + Mg(A.remainingTime) : I(),
      Q = h(() =>
  ...
  var Lg = (A) => {
    ...
    (G(async () => {
      ...
      (C({
        isPausable: A,
        isSeekable: E,
        containerW: d.offsetWidth,
        containerH: d.offsetHeight,
      }),
        L(e),
        B && I.play());
    }),
          ...
          return {
            init: async function () {
              ...
              const r =
                void 0 !== M
                  ? ((a = M),
                    C.filter((A) => A[0] < a && 'o' === A[1]).map((A) => A[2]))
                  : void 0;
              var a;
              return (
              ...
              if (65 == g[0] && 76 == g[1] && 105 == g[2] && 83 == g[3])
                if (1 == g[4]) {
                  ...
                  (0 == A
                    ...
                    : (t.error(`unsupported compression algorithm (${A})`),
                      s.close()),
                    (s.onmessage = y));
                } else
                  (t.warn(`unsupported ALiS version (${g[4]})`), s.close());
              else {
      ...
      [
        ...
        async function (A, g) {
          ...
          const e = await A[1].arrayBuffer(),
            ...
            o = B.decode(i.subarray(0, t)).match(
              /COLUMNS="(\d+)" LINES="(\d+)"/,
            );
